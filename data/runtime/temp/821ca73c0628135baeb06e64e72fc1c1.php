<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:86:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/productclass/editclassify.html";i:1574755896;s:72:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/base.html";i:1503645978;s:74:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/header.html";i:1573695866;s:76:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/left_nav.html";i:1554623682;s:76:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/head_nav.html";i:1554196766;s:74:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/footer.html";i:1554272462;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="row">
	<div class="col-xs-12">
					...
					<div class="col-xs-12">
						<form action="<?php echo url('editclassifydata'); ?>" method="post" class="form-horizontal">
							<div class="control-group">
								...
								<div class="controls">
									...
									<?php else: if(is_array($all_fl) || $all_fl instanceof \think\Collection || $all_fl instanceof \think\Paginator): if( count($all_fl)==0 ) : echo "" ;else: foreach($all_fl as $key=>$vo): if($vo['categoryId'] == $list['parentId']): ?>
												<span style="color:#000000;font-weight:bold;"><?php echo $vo['categoryName']; ?></span>
												<input type="hidden" id="pid" name="parentId" value="<?php echo $vo['categoryId']; ?>"/>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="categoryName" class="span11" placeholder="分类名称" value="<?php echo $list['categoryName']; ?>">
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="px" class="span11" placeholder="排序" value="<?php echo $list['px']; ?>">
								</div>
							</div>

							<div class="form-actions">
								<input type="hidden" id="categoryId" name="categoryId" value="<?php echo $list['categoryId']; ?>"/>
