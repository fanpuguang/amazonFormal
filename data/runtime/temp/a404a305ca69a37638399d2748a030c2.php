		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal adminform" name="admin_list_add" method="post" action="<?php echo url('admin/Admin/admin_runadd'); ?>">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 所属公司： </label>
						<div class="col-sm-10">
							<select name="fj_id"  class="col-sm-5">
								...
								<option value="<?php echo $v['admin_id']; ?>"><?php echo $v['admin_realname']; ?></option>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="admin_realname" id="admin_realname" placeholder="输入员工姓名" class="col-xs-10 col-sm-5" required/>
							<span class="lbl col-xs-12 col-sm-7"><span class="red">*</span>账号使用者，会有显示</span>
						</div>
					</div>
					<div class="space-4"></div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="en_name" id="en_name" placeholder="输入英文名称" class="col-xs-10 col-sm-5" required/>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="en_brand" id="en_brand" placeholder="输入英文品牌" class="col-xs-10 col-sm-5" required/>
