				...
				<div>
					<table class="table table-striped table-bordered table-hover" id="dynamic-table">
						...
						<tr>
							...
							<td>
								<span style="color:green"><?php echo get_shouquanname($v['UID']); ?></span>
								<?php if($v['store_id'] ==4): ?>
								德国
