<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:64:"D:\php\PHPTutorial\WWW\qiyetp5/app/admin\view\model\cmslist.html";i:1503645978;s:62:"D:\php\PHPTutorial\WWW\qiyetp5/app/admin\view\public\base.html";i:1503645978;s:64:"D:\php\PHPTutorial\WWW\qiyetp5/app/admin\view\public\header.html";i:1557369556;s:66:"D:\php\PHPTutorial\WWW\qiyetp5/app/admin\view\public\left_nav.html";i:1554623680;s:66:"D:\php\PHPTutorial\WWW\qiyetp5/app/admin\view\public\head_nav.html";i:1554196764;s:69:"D:\php\PHPTutorial\WWW\qiyetp5/app/admin\view\model\ajax_cmslist.html";i:1503645978;s:64:"D:\php\PHPTutorial\WWW\qiyetp5/app/admin\view\public\footer.html";i:1554272461;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content">
		<div class="row maintop">
			<div class="col-xs-4 col-sm-2  margintop5">
				<a href="<?php echo url('admin/Model/cmsadd',['id'=>$model_id]); ?>">
			...
			<form name="admin_list_sea" class="form-search form-horizontal" id="list-filter" method="post" action="<?php echo url('admin/Model/cmslist'); ?>">
			<div class="col-xs-8 col-sm-10 btn-sespan">
				...
				<div class="input-group-btn">
					<a href="<?php echo url('admin/Model/cmslist',['id'=>$model_id]); ?>">
		...
		<div class="row">
			<div class="col-xs-12">
				<form id="alldel" name="alldel" method="post" action="<?php echo url('admin/Model/cmsalldel'); ?>" >
					...
					<div>
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<tr>
								...
								<th>排序</th>
								<?php if(is_array($fields) || $fields instanceof \think\Collection || $fields instanceof \think\Paginator): if( count($fields)==0 ) : echo "" ;else: foreach($fields as $k=>$v): if($k != $model['model_order']): ?>
...
<tr>
    ...
    <?php switch($fields[$model['model_order']]['type']): case "number": ?>
    <td height="28" ><input name="<?php echo $v[$model['model_pk']]; ?>" value="<?php echo (isset($v[$model['model_order']]) && ($v[$model['model_order']] !== '')?$v[$model['model_order']]:50); ?>" class="list_order center"/></td>
    <?php break; case "datetime":case "date": ?>
	<td height="28" ><?php echo $v[$model['model_order']]; ?></td>
    <?php break; endswitch; if(is_array($fields) || $fields instanceof \think\Collection || $fields instanceof \think\Paginator): if( count($fields)==0 ) : echo "" ;else: foreach($fields as $k=>$vv): if($k != $model['model_order']): ?>
	<td height="28" ><?php echo $v[$k]; ?></td>
	<?php endif; endforeach; endif; else: echo "" ;endif; ?>
	<td>
		<div class="hidden-sm hidden-xs action-buttons">
			<a class="green"  href="<?php echo url('admin/Model/cmsedit',['id'=>$model_id,$model['model_pk']=>$v[$model['model_pk']]]); ?>" title="修改">
				<i class="ace-icon fa fa-pencil bigger-130"></i>
			</a>
			<a class="red confirm-rst-url-btn" href="<?php echo url('admin/Model/cmsdel',['id'=>$model_id,$model['model_pk']=>$v[$model['model_pk']]]); ?>" data-info="你确定要删除吗？" title="删除">
		...
		<div class="hidden-md hidden-lg">
			<div class="inline position-relative">
				...
				<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
					...
					<li>
						<a href="<?php echo url('admin/Model/cmsdel',['id'=>$model_id,$model['model_pk']=>$v[$model['model_pk']]]); ?>"  class="tooltip-error confirm-rst-url-btn" data-info="你确定要删除吗？" data-rel="tooltip" title="" data-original-title="删除">
							<span class="red">
...
<tr>
	...
	<td align="left" class="hidden-xs"><button  id="btnorder" href="<?php echo url('admin/Model/cmsorder',['id'=>$model_id]); ?>" class="btn btn-white btn-yellow btn-sm">排序</button></td>
