<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:79:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/plug/plug_sug_list.html";i:1578553888;s:72:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/base.html";i:1578553890;s:74:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/header.html";i:1586171204;s:76:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/left_nav.html";i:1578553891;s:76:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/head_nav.html";i:1578553891;s:84:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/plug/ajax_plug_sug_list.html";i:1578553887;s:74:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/footer.html";i:1578970335;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		<div class="col-xs-12 col-sm-1">
			...
			<a href="<?php echo url('admin/plug/shouquan'); ?>" class="btn btn-sm btn-danger" target="_blank" style="margin-right: -500px;">点击查看如何授权</a>
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" id="dynamic-table">
								...
								<tr>
									...
									<th class="hidden-xs">店铺名称</th>
									<th>账号</th>
									<th class="hidden-sm hidden-xs">授权国家</th>

									<th class="hidden-sm hidden-xs">授权时间</th>
	...
	<tr>
		...
		<td class="hidden-xs"><?php echo $v['plug_dpbm']; ?></td>
		<td height="28"><?php echo $v['plug_sug_name']; ?></td>
		<td class="hidden-sm hidden-xs">
			<?php if($v['plug_khqy'] == 0): ?>北美(North America)<?php endif; if($v['plug_khqy'] == 1): ?>欧洲(Europe)<?php endif; if($v['plug_khqy'] == 2): ?>日本(Japan)<?php endif; if($v['plug_khqy'] == 3): ?>澳大利亚(Australia)<?php endif; ?>
		...
		<td>
			<div class="action-buttons">
				...
				<a class="green sqedit-btn"  href="<?php echo url('admin/Plug/plug_sug_edit'); ?>" data-id="<?php echo $v['plug_sug_id']; ?>"  title="编辑">
...
<tr>
	...
	<td colspan="7" align="right"><?php echo $page; ?></td>
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 店铺别名：  </label>
										<div class="col-sm-10">
											<input  name="plug_dpbm" id="plug_dpbm" value="" class="col-xs-6"/>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Amazon账号：  </label>
										<div class="col-sm-10">
											<input  name="plug_sug_name" id="plug_sug_name" value="" class="col-xs-6"/>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 开户区域：  </label>
										<div class="col-sm-10">
											<select id="plug_khqy" class="form-control" name="plug_khqy">
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 卖家编号：  </label>
										<div class="col-sm-10">
											<input name="plug_merchant_id" id="plug_merchant_id" value="" class="col-xs-8"/>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1">添加授权令牌：  </label>
										<div class="col-sm-10">
											<input  name="plug_lingpai" id="plug_lingpai" value="" class="col-xs-8"/>
										</div>
									</div>
		...
		<div class="modal fade in" id="myModaledit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<form class="form-horizontal ajaxForm2" name="plug_sug_reply" method="post" action="<?php echo url('admin/plug/plug_sug_runedit'); ?>">
				<input type="hidden" name="plug_sug_id" id="edit_plug_sug_id" value="" />
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 店铺别名：  </label>
										<div class="col-sm-10">
											<input  name="plug_dpbm" id="edit_plug_dpbm" value="" class="col-xs-6"/>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Amazon账号：  </label>
										<div class="col-sm-10">
											<input  name="plug_sug_name" id="edit_plug_sug_name" value="" class="col-xs-6"/>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 开户区域：  </label>
										<div class="col-sm-10">
											<select id="edit_plug_khqy" class="form-control" name="plug_khqy">
												<option value="">-- 请选择 --</option>
												<option value="0" >北美(North America)</option>
												<option value="1">欧洲(Europe)</option>
												<option value="2">日本(Japan)</option>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 卖家编号：  </label>
										<div class="col-sm-10">
											<input name="plug_merchant_id" id="edit_plug_merchant_id" value="" class="col-xs-8"/>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1">添加授权令牌：  </label>
										<div class="col-sm-10">
											<input  name="plug_lingpai" id="edit_plug_lingpai" value="" class="col-xs-8"/>
										</div>
									</div>
