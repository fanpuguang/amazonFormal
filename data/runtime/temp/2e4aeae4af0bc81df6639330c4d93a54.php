<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:81:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/product/productclass.html";i:1569392580;s:72:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/base.html";i:1503645978;s:74:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/header.html";i:1573695866;s:76:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/left_nav.html";i:1554623682;s:76:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/head_nav.html";i:1554196766;s:74:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/footer.html";i:1554272462;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			<div>
				<form class="ajaxForm" name="source_order" method="post" action="<?php echo url('admin/product/productclass_order'); ?>" >
					<table class="table table-striped table-bordered table-hover" id="dynamic-table">
						...
						<?php if(is_array($productclass) || $productclass instanceof \think\Collection || $productclass instanceof \think\Paginator): if( count($productclass)==0 ) : echo "" ;else: foreach($productclass as $k=>$v): ?>
						<tr>
							...
							<td>
								<div class="hidden-sm hidden-xs action-buttons">
									...
									<a class="green productclassedit-btn"  href="<?php echo url('admin/product/productclass_edit'); ?>" data-id="<?php echo $v['id']; ?>"  title="修改">
										<i class="ace-icon fa fa-pencil bigger-130"></i>
									</a>
									<a data-toggle="modal" data-target="#myModal" class="ui-icon ace-icon fa fa-plus center bigger-110 blue"  href="<?php echo url('admin/product/productclass_add'); ?>" data-id="<?php echo $v['id']; ?>"  title="添加子类">

									</a>
									<a class="red confirm-rst-url-btn" data-info="你确定要删除吗？" href="<?php echo url('admin/product/productclass_del',array('id'=>$v['id'],'p'=>input('p',1))); ?>" title="删除">
								...
								<div class="hidden-md hidden-lg">
									<div class="inline position-relative">
										...
										<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
											<li>
												<a href="<?php echo url('admin/product/productclass_edit'); ?>" data-id="<?php echo $v['id']; ?>" class="tooltip-success productclassedit-btn" data-rel="tooltip" title="" data-original-title="修改">
																	<span class="green">
											...
											<li>
												<a href="<?php echo url('admin/product/productclass_del',array('id'=>$v['id'],'p'=>input('p',1))); ?>"  class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-info="你确定要删除吗？" data-original-title="删除">
																	<span class="red">
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<form class="form-horizontal ajaxForm2" name="fwq_add" method="post" action="<?php echo url('admin/product/productclass_runadd'); ?>">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="name" id="name" placeholder="分类名称" class="col-xs-10 col-sm-5" required/>
	...
	<div class="modal fade in" id="myModaledit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<form class="form-horizontal ajaxForm2" name="productclass_runedit" method="post" action="<?php echo url('admin/product/productclass_runedit'); ?>">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label no-padding-right" for="form-field-1">分类名称：  </label>
									<div class="col-sm-10">
										<input type="text" name="name" id="name" placeholder="输入分类名称" class="col-xs-10 col-sm-5"/>
