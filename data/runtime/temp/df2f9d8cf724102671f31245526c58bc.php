<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:78:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/home/view/default/user/login.html";i:1503645978;s:79:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/home/view/default/public/head.html";i:1503645978;s:83:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/home/view/default/public/function.html";i:1503645978;s:81:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/home/view/default/public/config.html";i:1503645978;s:78:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/home/view/default/public/nav.html";i:1503645978;s:81:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/home/view/default/public/footer.html";i:1564648404;s:82:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/home/view/default/public/scripts.html";i:1503645978;}*/ ?>
<!DOCTYPE html>
...
<head>
	<meta charset="utf-8">
	<title><?php echo lang('login'); ?> <?php echo $site_name; ?> </title>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-10 col-lg-offset-4 col-md-offset-4 col-sm-offset-3 col-xs-offset-1 animate_afr">
						<h2 class="text-center"><?php echo lang('user login'); ?></h2>
						<div class="widget tabs">
							<div id="horizontal-tabs">
								<div class="contents">
									<div class="tabscontent" id="content1" style="display: block;">
										<form id="login" class="form-light verify-ajax-form" action="<?php echo url('home/Login/runlogin'); ?>" method="post">
											<div>
												<input type="text" id="input_username" name="member_list_username" placeholder="<?php echo lang('username or email'); ?>" class="form-control">
											</div>
											<div>&nbsp;</div>
											<div>
												<input type="password" id="input_password" name="member_list_pwd" placeholder="<?php echo lang('pwd'); ?>" class="form-control">
											</div>
											<div>&nbsp;</div>
											<div class="row">
												<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
													<input type="text" class="form-control" id="verify" placeholder="" style="height:40px;" name="verify" required>
												</div>
												<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
													<img class="verify_img" id="verify_img" src="<?php echo url('home/Login/verify'); ?>" onClick="this.src='<?php echo url('home/Login/verify'); ?>'+'?'+Math.random()" style="cursor: pointer;width:100%;border: 1px solid #d5d5d5;height:40px;" title="<?php echo lang('click to get'); ?>">
												</div>
											</div>
											<div style="margin:5px 0">
											<input type="checkbox" checked="checked" name="remember" value="1" style="cursor:pointer;"><?php echo lang('remember'); ?>
											</div>
											<div>
												<button class="btn btn-primary col-lg-12 col-md-12 col-sm-12 col-xs-12"><?php echo lang('ok'); ?></button>
											</div>
											<div style="text-align: center; margin:5px 0">
												<div class="row">
													...
													<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
														<a href="<?php echo url('home/Login/forgot_pwd'); ?>"><?php echo lang('forget password'); ?></a>
													</div>
												</div>
											</div>
										</form>
