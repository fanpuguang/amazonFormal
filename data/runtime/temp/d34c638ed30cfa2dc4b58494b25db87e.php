...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form class="ajaxForm" name="source_order" method="post" action="<?php echo url('admin/Dataanalysis/dataanalysis_list'); ?>" >
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<?php if(is_array($dataanalysis) || $dataanalysis instanceof \think\Collection || $dataanalysis instanceof \think\Paginator): if( count($dataanalysis)==0 ) : echo "" ;else: foreach($dataanalysis as $k=>$v): ?>
								<tr>
									<td height="28" ><?php echo $k+1; ?></td>
									<td><?php echo mb_substr($v['title'],0,10,'utf-8'); ?>...</td>
									<td><?php echo $v['price']; ?></td>
									<td><?php if($v['is_chinese'] == 'True'): ?>是<?php else: ?>否<?php endif; ?></td>
									<td><a href="<?php echo $v['url']; ?>" target="_blank">访问</a></td>

									<td><?php echo $v['fa_data']; ?></td>
									<td><?php echo $v['asin']; ?></td>
									<td><?php echo $v['class_name']; ?></td>
									<td><?php echo $v['raking']; ?></td>
									<td><?php echo $v['starts']; ?></td>
									<td><?php echo $v['create_time']; ?></td>

									<!--<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a class="green fwqedit-btn"  href="<?php echo url('admin/Fwq/fwq_edit'); ?>" data-id="<?php echo $v['id']; ?>"  title="修改">
												<i class="ace-icon fa fa-pencil bigger-130"></i>
											</a>
											<a class="red confirm-rst-url-btn" data-info="你确定要删除吗？" href="<?php echo url('admin/Fwq/fwq_del',array('id'=>$v['id'],'p'=>input('p',1))); ?>" title="删除">
										...
										<div class="hidden-md hidden-lg">
											<div class="inline position-relative">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													<li>
														<a href="<?php echo url('admin/Fwq/fwq_edit'); ?>" data-id="<?php echo $v['id']; ?>" class="tooltip-success sourceedit-btn" data-rel="tooltip" title="" data-original-title="修改">
																	<span class="green">
													...
													<li>
														<a href="<?php echo url('admin/Fwq/fwq_del',array('id'=>$v['id'],'p'=>input('p',1))); ?>"  class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-info="你确定要删除吗？" data-original-title="删除">
																	<span class="red">
							...
							<tr>
								...
								<td height="50" colspan="11" align="right"><?php echo $page; ?></td>
							</tr>
							</tbody>
						</table>
					</form>
