...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
			...
			<div class="col-xs-12">
				<form class="form-horizontal adminform" name="admin_list_edit" method="post" action="<?php echo url('admin/Admin/admin_runedit'); ?>">
					...
					<!--<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 所属用户组： </label>
						<div class="col-sm-10">
							<select name="fj_id"  class="col-sm-5">
								<option value="">请选择所属公司</option>
								<?php if(is_array($gongsi_group) || $gongsi_group instanceof \think\Collection || $gongsi_group instanceof \think\Paginator): if( count($gongsi_group)==0 ) : echo "" ;else: foreach($gongsi_group as $key=>$v): ?>
								<option value="<?php echo $v['admin_id']; ?>" <?php if($v['admin_id'] == $admin_list['fj_id']): ?>selected<?php endif; ?>><?php echo $v['admin_realname']; ?></option>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 员工姓名：  </label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="en_name" id="en_name" value="<?php echo $admin_list['en_name']; ?>"   placeholder="输入英文名称" class="col-xs-10 col-sm-5" required/>
							<span class="lbl col-xs-12 col-sm-7"><span class="red">*用于生产SKU</span></span>
						</div>
					</div>
					<div class="space-4"></div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="en_brand" id="en_brand" value="<?php echo $admin_list['en_brand']; ?>"   placeholder="输入英文品牌" class="col-xs-10 col-sm-5" required/>
							<span class="lbl col-xs-12 col-sm-7"><span class="red">*全大写英文字母，用于生产SKU</span></span>
						</div>
					</div>
					<div class="space-4"></div>

					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 账户余额：  </label>
						<div class="col-sm-3">
							<input type="number" name="money" id="money"  class="col-xs-10 col-sm-5" value="<?php echo $admin_list['money']; ?>" disabled/>

							<a class="btn btn-sm btn-danger zhedit-btn" href="<?php echo url('admin/Admin/admin_money'); ?>" data-id="<?php echo $admin_list['admin_id']; ?>" style="cursor:pointer;" class="">账号充值</a>
						</div>
					</div>
					<div class="space-4"></div>
		...
		<div class="modal fade in" id="myModaledit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<form class="form-horizontal ajaxForm2" name="chongzhi_runedit" method="post" action="<?php echo url('admin/Admin/admin_money'); ?>">
				<input type="hidden" name="yonghu_id" id="yonghu_id" value="<?php echo $admin_list['admin_id']; ?>" />
						...
						<div class="modal-body">
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1">充值金额：  </label>
										<div class="col-sm-10">
											<input type="number" name="moneys" id="moneys"  class="col-xs-10 col-sm-5"/>
