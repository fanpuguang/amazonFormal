	...
	<div class="page-content">
		...
		<div class="row maintop">
			<div class="col-xs-4 col-sm-2 margintop5">
				<a href="<?php echo url('admin/Admins/admin_add'); ?>">
			...
			<div class="col-xs-10 col-sm-5 margintop5">
				<form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('admin/Admins/admin_list'); ?>">
			...
			<div class="col-xs-4 col-sm-5 margintop5">
				<div class="input-group-btn">
					<a href="<?php echo url('admin/Admins/admin_list'); ?>">
						...
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<?php if(is_array($admin_list) || $admin_list instanceof \think\Collection || $admin_list instanceof \think\Paginator): if( count($admin_list)==0 ) : echo "" ;else: foreach($admin_list as $k=>$v): ?>
								<tr>
									...
									<td style="color:red;">【<?php echo get_groups($v['admin_id']); ?>】</td>
									<td class="hidden-sm hidden-xs"><?php echo $v['admin_email']; ?></td>
									<td class="hidden-sm hidden-xs" style="color:red;"><?php echo $v['money']; if($pid != 1): ?>&nbsp;&nbsp;<a href="<?php echo url('admin/Admins/admin_money'); ?>" data-id="<?php echo $v['admin_id']; ?>" style="cursor:pointer;" class="zhedit-btn">分配余额</a><?php endif; ?></td>
									...
									<td>
										<?php if($v['admin_open'] == 1): ?>
											<a class="red open-btn" href="<?php echo url('admin/Admins/admin_state'); ?>" data-id="<?php echo $v['admin_id']; ?>" title="已开启">
												<div id="zt<?php echo $v['admin_id']; ?>"><button class="btn btn-minier btn-yellow">开启</button></div>
											</a>
											<?php else: ?>
											<a class="red open-btn" href="<?php echo url('admin/Admins/admin_state'); ?>" data-id="<?php echo $v['admin_id']; ?>" title="已禁用">
									...
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<?php if($pid == 1 && $v['fj_id'] == 1): else: ?>
											<a class="green" href="<?php echo url('admin/Admins/admin_edit',array('admin_id'=>$v['admin_id'])); ?>" title="修改">
												<i class="ace-icon fa fa-pencil bigger-130"></i>																</a>
											<?php endif; if($v['fj_id'] != 1): ?>
												<a class="red confirm-rst-url-btn" data-info="你确定要删除吗？" href="<?php echo url('admin/Admins/admin_del',array('admin_id'=>$v['admin_id'])); ?>" title="删除">
													<i class="ace-icon fa fa-trash-o bigger-130"></i>
												</a>
											<?php endif; if($pid == 1 && $v['fj_id'] == 1): ?><a href="<?php echo url('admin/Admins/admin_list',array('admin_id'=>$v['admin_id'])); ?>">查看员工账号</a><?php endif; ?>
										...
										<div class="hidden-md hidden-lg">
											<div class="inline position-relative">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													<?php if($pid == 1 && $v['fj_id'] == 1): else: ?>
													<li>
														<a href="<?php echo url('admin/Admins/admin_edit',array('admin_id'=>$v['admin_id'])); ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
																	<span class="green">
																		<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																	</span>
														</a>
													</li>
													<?php endif; if($v['admin_id'] != 1): ?>
														<li>
															<a href="<?php echo url('admin/Admins/admin_del',array('admin_id'=>$v['admin_id'])); ?>"  data-info="你确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-original-title="删除">
																	<span class="red">
		...
		<div class="modal fade in" id="myModaledit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<form class="form-horizontal ajaxForm2" name="fwq_runedit" method="post" action="<?php echo url('admin/Admins/admin_money'); ?>">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="form-group">
										...
										<div class="col-sm-10" style="margin-top: 8px;" id="zongqian" style="color:red;"><?php echo $admin1['money']; ?></div>
									</div>
...
<script>
	$("#money").bind("input propertychange", function() {
		var qian = $("#money").val();
		var zongqian = '<?php echo $admin1['money']; ?>';
