<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:78:"/www/wwwroot/www.ldkjmy.com/yamaxun/app/admin/view/productupload/myupload.html";i:1576224804;s:67:"/www/wwwroot/www.ldkjmy.com/yamaxun/app/admin/view/public/base.html";i:1503645978;s:69:"/www/wwwroot/www.ldkjmy.com/yamaxun/app/admin/view/public/header.html";i:1573695866;s:71:"/www/wwwroot/www.ldkjmy.com/yamaxun/app/admin/view/public/left_nav.html";i:1576199128;s:71:"/www/wwwroot/www.ldkjmy.com/yamaxun/app/admin/view/public/head_nav.html";i:1554196766;s:69:"/www/wwwroot/www.ldkjmy.com/yamaxun/app/admin/view/public/footer.html";i:1575530481;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
					...
					<table class="table table-striped table-bordered table-hover" id="dynamic-table">
						...
						<tr>
							...
							<td>
								...
								<a href="#" class="feed" data-id=<?php echo $v['id']; ?> data-type='product'>上传</a>
								<?php elseif($v['product_status'] == 1): ?>
								<a href="#" class="getList" data-id=<?php echo $v['id']; ?> data-type='product'>更新</a>
								<?php elseif($v['product_status'] == 2): ?>
								<a href="#" class="getResult" data-id=<?php echo $v['id']; ?> data-type='product'>获取结果</a>
								<?php elseif($v['product_status'] == 3): ?>
								<a href="#">上传成功</a>
								<?php elseif($v['product_status'] == 4): ?>
								<a href="#" onclick="getError(<?php echo $v['product_submission']; ?>)">错误详情</a>
								<a href="#">上传失败</a>
								<a href="#" class="feed" data-id=<?php echo $v['id']; ?> data-type='product'>重新上传</a>
								<?php endif; ?>
							</td>
							<td>	
								<?php if($v['product_status'] == 3): if($v['relationships_status'] == 0): ?>
								<a href="#" class="feed" data-id=<?php echo $v['id']; ?> data-type='relationships'>上传</a>
								<?php elseif($v['relationships_status'] == 1): ?>
								<a href="#" class="getList" data-id=<?php echo $v['id']; ?> data-type='relationships'>更新</a>
								<?php elseif($v['relationships_status'] == 2): ?>
								<a href="#" class="getResult" data-id=<?php echo $v['id']; ?> data-type='relationships'>获取结果</a>
								<?php elseif($v['relationships_status'] == 3): ?>
								<a href="#">上传成功</a>
								<?php elseif($v['relationships_status'] == 4): ?>
								<a href="#" onclick="getError(<?php echo $v['product_submission']; ?>)">错误详情</a>
								<a href="#">上传失败</a>
								<a href="#" class="feed" data-id=<?php echo $v['id']; ?> data-type='relationships'>重新上传</a>
								<?php endif; endif; ?>
							</td>
							<td>
								<?php if($v['product_status'] == 3): if($v['img_status'] == 0): ?>
								<a href="#" class="feed" data-id=<?php echo $v['id']; ?> data-type='img'>上传</a>
								<?php elseif($v['img_status'] == 1): ?>
								<a href="#" class="getList" data-id=<?php echo $v['id']; ?> data-type='img'>更新</a>
								<?php elseif($v['img_status'] == 2): ?>
								<a href="#" class="getResult" data-id=<?php echo $v['id']; ?> data-type='img'>获取结果</a>
							...
							<td>
								...
								<a href="#" class="feed" data-id=<?php echo $v['id']; ?> data-type='inventory'>上传</a>
								<?php elseif($v['inventory_status'] == 1): ?>
								<a href="#" class="getList" data-id=<?php echo $v['id']; ?> data-type='inventory'>更新</a>
								<?php elseif($v['inventory_status'] == 2): ?>
								<a href="#" class="getResult" data-id=<?php echo $v['id']; ?> data-type='inventory'>获取结果</a>
							...
							<td>
								...
								<a href="#" class="feed" data-id=<?php echo $v['id']; ?> data-type='price'>上传</a>
								<?php elseif($v['price_status'] == 1): ?>
								<a href="#" class="getList" data-id=<?php echo $v['id']; ?> data-type='price'>更新</a>
								<?php elseif($v['price_status'] == 2): ?>
								<a href="#" class="getResult" data-id=<?php echo $v['id']; ?> data-type='price'>获取结果</a>
							...
							<td>
								<?php if($v['product_status'] == 0): ?>
								<a href="#" class="feed" data-id=<?php echo $v['id']; ?> data-type='all'>上传</a>
								<?php endif; ?>
							</td>
						<!-- 	<td>
								<?php echo $v['category']; ?>
							...
							<td>
							<a href="<?php echo url('admin/Productupload/editRecord',array('id'=>$v['id'])); ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
											<span class="green">
												<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
											</span>
							</a>
							<a href="<?php echo url('admin/Productupload/deleteRecord',array('id'=>$v['id'])); ?>" data-info="你确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="删除" data-original-title="删除">
											<span class="red">
	...
	<script type="text/javascript">
		$('.feed').click(function(){
			...
			parent.html('上传中')
			$.ajax({
					url:'<?php echo url('admin/Feed/createXml'); ?>',
		...
		$('.getList').click(function(){
			...
			parent.html('更新中')
			$.ajax({
					url:'<?php echo url('admin/Feed/getFeedSubmissionList'); ?>',
					data:{recordId:id,type:type},
					type:'post',
					dataType: 'json',
					success:function(result){
		...
		$('.getResult').click(function(){
			...
			parent.html('获取中请稍后')
			$.ajax({
					url:'<?php echo url('admin/Feed/GetFeedSubmissionResult'); ?>',
					data:{recordId:id,type:type},
					type:'post',
					dataType: 'json',
					success:function(result){
		...
		function getError(submission){
			$.ajax({
					url:'<?php echo url('admin/Feed/GetError'); ?>',
					...
					success:function(result){
						if(result.msg== 'success'){
							...
							for (var i = result.data.length - 1; i >= 0; i--) {
								...
								var url = "<?php echo url('admin/Productupload/skuGetGoods'); ?>"
								html += "<tr>"	
