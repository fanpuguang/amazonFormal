<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:83:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/product/product_upload.html";i:1574995265;s:72:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/base.html";i:1503645978;s:74:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/header.html";i:1573695866;s:76:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/left_nav.html";i:1554623682;s:76:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/head_nav.html";i:1554196766;s:74:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/footer.html";i:1554272462;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="row">
			<div class="col-xs-12">
				<div id="step" class="box">
					<form method="post" action="<?php echo url('admin/feed/creatLocalXml'); ?>" >
										...
										<div class="el-input el-input--suffix">
											...
											<!---->
												<select name="goodsCate"  class="col-sm-5 selector" required id="test111" onchange="fenlei(this.value)" >
													...
													<option value="4"><?php echo $admin_realname; ?>德国</option>
													<option value="5"><?php echo $admin_realname; ?>英国</option>
													<option value="6"><?php echo $admin_realname; ?>意大利</option>
													<option value="7"><?php echo $admin_realname; ?>法国</option>
													<option value="8"><?php echo $admin_realname; ?>西班牙</option>
													<?php else: ?>
													<option value="<?php echo $v['plug_khqy']; ?>"><?php echo $admin_realname; if($v['plug_khqy'] == 0): ?>-(北美)<?php endif; if($v['plug_khqy'] == 2): ?>-(日本)<?php endif; if($v['plug_khqy'] == 3): ?>-(澳大利亚)<?php endif; ?>
													</option>
                        ...
                        <a class="layui-layer-ico layui-layer-close layui-layer-close2" onclick="guanbi()">
								...
								<script>
									...
									$("#submit").click(function(){
										...
										$.ajax({
											url:'<?php echo url('admin/Feed/addLocalSubmit'); ?>',
