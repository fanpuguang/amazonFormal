...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal adminform" name="admin_list_edit" method="post" action="<?php echo url('admin/Admins/admin_runedit'); ?>">
					<input name="admin_id" id="admin_id" type="hidden" value="<?php echo $admin_list['admin_id']; ?>" />
					<?php if($admin_list['fj_id'] != 1): ?>
