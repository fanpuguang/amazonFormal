<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:82:"/www/wwwroot/www.ldkjmy.com/yamaxun/app/admin/view/productupload/smartuploads.html";i:1576232014;s:67:"/www/wwwroot/www.ldkjmy.com/yamaxun/app/admin/view/public/base.html";i:1503645978;s:69:"/www/wwwroot/www.ldkjmy.com/yamaxun/app/admin/view/public/header.html";i:1573695866;s:71:"/www/wwwroot/www.ldkjmy.com/yamaxun/app/admin/view/public/left_nav.html";i:1576199128;s:71:"/www/wwwroot/www.ldkjmy.com/yamaxun/app/admin/view/public/head_nav.html";i:1554196766;s:69:"/www/wwwroot/www.ldkjmy.com/yamaxun/app/admin/view/public/footer.html";i:1575530481;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
					...
					<table class="table table-striped table-bordered table-hover" id="dynamic-table">
						...
						<tr>
							...
							<td class="hidden-xs" align="center" style="color:green;">
								<?php if(is_array($list_fenlei) || $list_fenlei instanceof \think\Collection || $list_fenlei instanceof \think\Paginator): if( count($list_fenlei)==0 ) : echo "" ;else: foreach($list_fenlei as $key=>$vo): if($vo['categoryId'] == $v['class1']): ?><?php echo $vo['categoryName']; ?>/<?php endif; if($vo['categoryId'] == $v['class2']): ?><?php echo $vo['categoryName']; ?>/<?php endif; if($vo['categoryId'] == $v['class3']): ?><?php echo $vo['categoryName']; endif; endforeach; endif; else: echo "" ;endif; ?>
							</td>
							...
							<td>
								<div class="hidden-sm hidden-xs action-buttons">
									...
									<a href="<?php echo url('admin/Productupload/smartupload_del',array('Id'=>$v['id'],'p'=>input('p',1))); ?>" data-info="你确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="删除" data-original-title="删除">
										&nbsp;&nbsp;&nbsp;删除
									</a>
		...
		<div class="modal fade in" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<form class="form-horizontal ajaxForm2" name="product_caiji" method="post" action="<?php echo url('admin/productupload/product_caiji'); ?>">
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="url" id="url"  class="col-xs-10 col-sm-11" placeholder="要采集的亚马逊某个品类商品列表页面" required/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="k_url" id="k_url"  class="col-xs-10 col-sm-11" placeholder="要采集的商品榜单bast页面"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="abbreviation" id="abbreviation"  class="col-xs-10 col-sm-11" placeholder="商品的中文名称（例：烟灰缸）" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="e_abbreviation" id="e_abbreviation"  class="col-xs-10 col-sm-11" placeholder="商品的英文简称（例：ashtray）" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="s_page" id="s_page"  class="col-xs-10 col-sm-11" placeholder="要采商品列表页面的页码起始页码" required/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="e_page" id="e_page"  class="col-xs-10 col-sm-11" placeholder="要采商品列表页面的页码结束页码" required/>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input type="number" name="pic_num" id="pic_num"  class="col-xs-10 col-sm-11" placeholder="图片小于该张数的商品不采集" required/>

										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <span style="color:red;">*</span>采集用于：  </label>
										<div class="col-sm-5">
