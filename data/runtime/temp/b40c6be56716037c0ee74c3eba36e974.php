<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:85:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/productclass/addclassify.html";i:1574756888;s:72:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/base.html";i:1503645978;s:74:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/header.html";i:1573695866;s:76:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/left_nav.html";i:1554623682;s:76:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/head_nav.html";i:1554196766;s:74:"/www/wwwroot/www.ldkjmy.com/aaaa/yamaxun/app/admin/view/public/footer.html";i:1554272462;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="col-xs-12">
						<form action="<?php echo url('addclassifydata'); ?>" method="post" class="form-horizontal">
							<div class="control-group">
								<label class="control-label">所属栏目：</label>
								<div class="controls">
									<?php if($list['categoryId'] == ''): ?>
										<span style="color:#000000;font-weight:bold;" >顶级栏目</span>
										<input type="hidden" id="parentId" name="parentId" value="0"/>
									<?php else: if(is_array($all_fl) || $all_fl instanceof \think\Collection || $all_fl instanceof \think\Paginator): if( count($all_fl)==0 ) : echo "" ;else: foreach($all_fl as $key=>$vo): if($vo['categoryId'] == $list['categoryId']): ?>
												<span style="color:#000000;font-weight:bold;"><?php echo $vo['categoryName']; ?></span>
												<input type="hidden" id="parentId" name="parentId" value="<?php echo $vo['categoryId']; ?>"/>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="categoryName" class="span11" placeholder="分类名称">
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="px" class="span11" placeholder="排序">
								</div>
							</div>
