					...
					<form class="ajaxForm2" name="leftnav" method="post" action="" >
						<table class="table table-bordered table-striped with-check" id="list-table">
							...
							<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
										...
										<tr class="<?php echo $vo['flags']; ?>" id="<?php echo $vo['parentId']; ?>_<?php echo $vo['categoryId']; ?>">
											<td valign="middle">&nbsp;<?php echo $vo['categoryId']; ?></td>
											<td width="25%" valign="middle">
												<?php if($vo['parentId'] == 0): ?>
													<img src="__PUBLIC__/ace/menu_minus.gif" id="icon_<?php echo $vo['parentId']; ?>_<?php echo $vo['categoryId']; ?>" onclick="rowClicked(this)"/><strong style="color:#000000"><?php echo $vo['categoryName']; ?></strong>
												<?php else: ?>
													<?php echo $vo['tmp']; ?><img src="__PUBLIC__/ace/menu_minus.gif" id="icon_<?php echo $vo['parentId']; ?>_<?php echo $vo['categoryId']; ?>" onclick="rowClicked(this)"/><?php echo $vo['categoryName']; endif; ?>
											</td>

											<td valign="middle">

												<a href="<?php echo url('editclassify?categoryId='.$vo['categoryId']); ?>" class="btn btn-info">修改</a>
												<a href="<?php echo url('delclassify?categoryId='.$vo['categoryId']); ?>" class="btn btn-danger" onClick="return confirm('您确定要将它删除吗')">删除</a>
												<a href="<?php echo url('addclassify?categoryId='.$vo['categoryId']); ?>" class="btn btn-success">添加子栏目</a>
											</td>
										</tr>
