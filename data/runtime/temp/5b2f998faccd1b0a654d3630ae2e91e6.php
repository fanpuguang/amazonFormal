<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:74:"D:\php\PHPTutorial\WWW\qiyetp5/app/admin\view\comment\comment_setting.html";i:1503645978;s:62:"D:\php\PHPTutorial\WWW\qiyetp5/app/admin\view\public\base.html";i:1503645978;s:64:"D:\php\PHPTutorial\WWW\qiyetp5/app/admin\view\public\header.html";i:1557369556;s:66:"D:\php\PHPTutorial\WWW\qiyetp5/app/admin\view\public\left_nav.html";i:1554623680;s:66:"D:\php\PHPTutorial\WWW\qiyetp5/app/admin\view\public\head_nav.html";i:1554196764;s:64:"D:\php\PHPTutorial\WWW\qiyetp5/app/admin\view\public\footer.html";i:1554272461;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="csys" method="post" action="<?php echo url('admin/Comment/runcsys'); ?>">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right"> 是否开启评论： </label>
						<div class="col-sm-9" style="padding-top:5px;">
							<input name="t_open" id="t_open" <?php if($csys['t_open'] == 1): ?>checked<?php endif; ?>  value="1" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" />
							<span class="lbl"></span>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right"> 评论间隔时间： </label>
						<div class="col-sm-9">
							<input type="number" name="t_limit" id="t_limit" value="<?php echo $csys['t_limit']; ?>"  placeholder="请输入间隔时间"  class="col-xs-10 col-sm-5" required/>
							<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>单位(秒)</span>
