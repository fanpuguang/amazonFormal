			...
			<div>
				<form id="leftnav" name="leftnav" method="post" action="" >
					...
					<table class="table table-striped table-bordered table-hover" id="dynamic-table">
						...
						<?php if(is_array($money_list) || $money_list instanceof \think\Collection || $money_list instanceof \think\Paginator): if( count($money_list)==0 ) : echo "" ;else: foreach($money_list as $k=>$v): ?>
						<tr>
							<td ><?php echo $k+1; ?></td>
							<td >
								<?php if(is_array($admin1) || $admin1 instanceof \think\Collection || $admin1 instanceof \think\Paginator): if( count($admin1)==0 ) : echo "" ;else: foreach($admin1 as $k1=>$v1): if($v['cz_uid'] == $v1['admin_id']): ?>
										<?php echo $v1['admin_realname']; endif; endforeach; endif; else: echo "" ;endif; ?>
							</td>
