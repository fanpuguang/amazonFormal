			...
			<div class="col-xs-12">
				<div id="step" class="box">
                    ...
                    <span>
                        ...
                        <input type="text" placeholder="建议填写" class="startId" required="required" value="<?php echo $record['startId']; ?>">
                        <p>
                        ...
                        <input type="text" placeholder="建议填写" class="endId" required="required" value="<?php echo $record['endId']; ?>">
                        <p>
                            要导出产品的结束ID，结束ID起始ID
                        </p>
                    </span>
                        ...
                        <a class="layui-layer-ico layui-layer-close layui-layer-close2" onclick="guanbi()">
								...
								<script>
									...
									$("#submit").click(function(){
										...
										$.ajax({
											url:'<?php echo url('admin/productupload/updateRecord'); ?>',
											data:{startId:startId,endId:endId,goodsCate:goodsCate,nodeId:nodeId,templateType:templateType,category:category,id:id,categoryName:categoryName,categoryDetail:categoryDetail},
											type:'post',
											dataType: 'json',
											success:function(result){
